...
public class ExtendCommandParserTest {

    private ExtendCommandParser parser = new ExtendCommandParser();

    @Test
    public void parse_allFieldsPresent_success() {
        String userInput = " " + PREFIX_BOOK + "Some Book " + PREFIX_EMAIL + "example@example.com";
        ExtendCommand expectedCommand = new ExtendCommand(new BookName("Some Book"), new Email("example@example.com"));
    ...
    public void parse_missingBookPrefix_failure() {
        ...
        assertParseFailure(parser,
                userInput,
                String.format(MESSAGE_INVALID_COMMAND_FORMAT, ExtendCommand.MESSAGE_USAGE));
    }
